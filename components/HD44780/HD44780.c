...
#define LCD_ENTRY_MODE          0x04        // shift cursor from left to right on read/write
#define LCD_DISPLAY_OFF         0x08        // turn display off
#define LCD_DISPLAY_ON          0x04        // display on, cursor off, don't blink character
#define LCD_FUNCTION_RESET      0x20        // reset the LCD
